/****************************************************************************
** Meta object code from reading C++ file 'ChessBoardWidget.hpp'
**
...
#include "../../../../../include/ChessBoardWidget.hpp"
...
#error "The header file 'ChessBoardWidget.hpp' doesn't include <QObject>."
...
void ChessBoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->historyUpdated((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ChessBoardWidget::*)(const QString & )>(_a, &ChessBoardWidget::statusChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ChessBoardWidget::*)(const QString & )>(_a, &ChessBoardWidget::historyUpdated, 1))
            return;
    }
}
...
// SIGNAL 0
void ChessBoardWidget::statusChanged(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ChessBoardWidget::historyUpdated(const QString & _t1)
{
